                                ...
                                <div class="tab-pane fade show active" id="one-way" role="tabpanel" aria-labelledby="one-way-tab">
                                    <div class="contact-form-action">
                                        <form action="#" class="row align-items-center">
                                            ...
                                            <div class="col-lg-3">
                                                <a href="/flight/search-result" class="theme-btn w-100 text-center margin-top-20px">Search Now</a>
                                            </div>
                                        </form>
                                    </div>
                                </div><!-- end tab-pane -->
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item flight-card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-title"><a href="/flight/details">London to Paris</a></h3>
                        ...
                        <div class="card-price d-flex align-items-center justify-content-between">
                            ...
                            <a href="/flight/details" class="btn-text">Read details<i class="la la-angle-right"></i></a>
                        </div>
                    </div>
                </div><!-- end card-item -->
            </div><!-- end col-lg-4 -->
                ...
                <div class="card-item flight-card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-title"><a href="/flight/details">Dubai to Spain</a></h3>
                ...
                <div class="card-item flight-card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-title"><a href="/flight/details">Bangkok to Australia</a></h3>
                        <p class="card-meta">One way Flight</p>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__from">From</span>
                ...
                <div class="card-item flight-card">
                    ...
                    <div class="card-body">
                        <img src="{{ asset('assets/images/american-airline.png') }}" alt="" class="flight-logo">
                        <h3 class="card-title"><a href="/flight/details">London to Turkey</a></h3>
                        <p class="card-meta">Round-trip Flight</p>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__from">From</span>
                ...
                <div class="card-item flight-card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-title"><a href="/flight/details">New york to Dubai</a></h3>
                        <p class="card-meta">Round-trip Flight</p>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__from">From</span>
                ...
                <div class="card-item flight-card">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-title"><a href="/flight/details">Dhaka to Chicago</a></h3>
                        <p class="card-meta">One way Flight</p>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__from">From</span>
                    ...
                    <div class="car-wrap">
                        <div class="car-carousel carousel-action">
                            <div class="card-item destination-card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title"><a href="/activities/details">Main Street Park</a></h3>
                            ...
                            <div class="card-item destination-card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title"><a href="/activities/details">Chicago Cultural Center</a></h3>
                                    <div class="card-rating d-flex align-items-center">
                                        <span class="ratings d-flex align-items-center mr-1">
                                            <i class="la la-star"></i>
                                            <i class="la la-star"></i>
                            ...
                            <div class="card-item destination-card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title"><a href="/activities/details">Lugard Road Lookout</a></h3>
                                    <div class="card-rating d-flex align-items-center">
                                        <span class="ratings d-flex align-items-center mr-1">
                                            <i class="la la-star"></i>
                                            <i class="la la-star"></i>
                            ...
                            <div class="card-item destination-card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-title"><a href="/activities/details">Planet Hollywood Resort</a></h3>
                                    <div class="card-rating d-flex align-items-center">
                                        <span class="ratings d-flex align-items-center mr-1">
                                            <i class="la la-star"></i>
                                            <i class="la la-star"></i>
        ...
        <div class="container">
            ...
            <div class="row padding-top-50px">
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">San Francisco</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Spain</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Italy</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Florida</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Philippines</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Australia</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Hawaii</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="deal-list">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="title"><a href="/flight/details">Las Vegas</a></h5>
                            <span class="font-weight-bold font-size-18">$359.00</span>
                        </div>
                        <a href="/flight/details" class="theme-btn theme-btn-small">Book</a>
                    </div>
                    ...
                    <div class="card-item blog-card">
                        <div class="card-img">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title line-height-26"><a href="/blog/details"> Travel to Popular Sites & Don’t Rule Out Other Locations</a></h3>
                                <p class="card-meta">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="btn-box text-center pt-4">
                        <a href="/blog" class="theme-btn">Read More Post</a>
                    </div>
                </div>
            </div>
        </div><!-- end container -->
