...
@section('content')
                    ...
                    <div class="col-lg-7">
                        <div class="hero-content mt-0">
                            <div class="section-heading">
                                <h2 class="sec__title">Find the Best Car that <br> Fits Your Needs</h2>
    ...
    </svg><span>24/7 Customer Support</span></li>
                            </ul>
                        </div>
                    </div><!-- end col-lg-7 -->
                    <div class="col-lg-5">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="City, airport, station or address">
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-12 -->
                    ...
                    <div class="car-carousel carousel-action">
                        <div class="card-item car-card mb-0 border">
                            <div class="card-img">
                                ...
                                <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Add to wishlist">
    ...
    <section class="funfact-area padding-top-100px">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading text-center">
                        <h2 class="sec__title">World's Biggest Online Car Hire Service</h2>
                        <p class="sec__desc pt-3">Why you can find the right car in the right place with us.</p>
                    </div><!-- end section-heading -->
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="client-logo">
                        <div class="client-logo-item client-logo-item-2">
                            <img src="{{ asset('assets/images/alamo.png') }}" alt="brand image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item client-logo-item-2">
                            <img src="{{ asset('assets/images/europcar.png') }}" alt="brand image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item client-logo-item-2">
                            <img src="{{ asset('assets/images/hertz.png') }}" alt="brand image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item client-logo-item-2">
                            <img src="{{ asset('assets/images/national.png') }}" alt="brand image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item client-logo-item-2">
                            <img src="{{ asset('assets/images/thrifty.png') }}" alt="brand image">
                        </div><!-- end client-logo-item -->
                        <div class="client-logo-item client-logo-item-2">
                            <img src="{{ asset('assets/images/vologo.png') }}" alt="brand image">
                        </div><!-- end client-logo-item -->
                    </div><!-- end client-logo -->
                </div><!-- end col-lg-8 -->
            </div><!-- end row -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="btn-box btn--box text-right">
                        <a href="/activities/search-list" class="theme-btn">Discover More <i class="la la-arrow-right ml-1"></i></a>
                    </div>
                </div>
            </div><!-- end row -->
            <div class="row padding-top-50px">
                <div class="col-lg-4 responsive-column">
                    <div class="card-item destination-card destination--card">
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0"><a href="/activities/details">California</a></h3>
                            </div>
                            <div>
                                <a href="/activities/details" class="theme-btn theme-btn-small border-0">Explore <i class="la la-arrow-right ml-1"></i></a>
                            </div>
                        </div>
                    </div><!-- end card-item -->
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 responsive-column">
                    <div class="card-item destination-card destination--card">
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0"><a href="/activities/details">New York</a></h3>
                            </div>
                            <div>
                                <a href="/activities/details" class="theme-btn theme-btn-small border-0">Explore <i class="la la-arrow-right ml-1"></i></a>
                            </div>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item destination-card destination--card">
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0"><a href="/activities/details">San Francisco</a></h3>
                            </div>
                            <div>
                                <a href="/activities/details" class="theme-btn theme-btn-small border-0">Explore <i class="la la-arrow-right ml-1"></i></a>
                            </div>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item destination-card destination--card">
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0"><a href="/activities/details">Los Angeles</a></h3>
                            </div>
                            <div>
                                <a href="/activities/details" class="theme-btn theme-btn-small border-0">Explore <i class="la la-arrow-right ml-1"></i></a>
                            </div>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item destination-card destination--card">
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0"><a href="/activities/details">Melbourne</a></h3>
                            </div>
                            <div>
                                <a href="/activities/details" class="theme-btn theme-btn-small border-0">Explore <i class="la la-arrow-right ml-1"></i></a>
                            </div>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item destination-card destination--card">
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="card-title mb-0"><a href="/activities/details">London</a></h3>
                            </div>
                            <div>
                                <a href="/activities/details" class="theme-btn theme-btn-small border-0">Explore <i class="la la-arrow-right ml-1"></i></a>
                            </div>
                    ...
                    <div class="accordion accordion-item" id="accordionExample">
                        <div class="card">
                            ...
                            <div id="faqCollapseOne" class="collapse show" aria-labelledby="faqHeadingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusamus aliquid at, aut cumque cupiditate delectus dignissimos</p>
                            ...
                            <div class="form-content">
                                <div class="contact-form-action">
                                    <form method="post">
                                        ...
                                        <div class="btn-box">
                                            <button type="button" class="theme-btn">Send Message <i class="la la-arrow-right ml-1"></i></button>
                                        </div>
                                    </form>
