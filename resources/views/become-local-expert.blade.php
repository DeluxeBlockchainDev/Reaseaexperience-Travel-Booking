                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title line-height-55 text-white">Let's Show the Beauty of Your
                                    <br> City to the World</h2>
                                <p class="sec__desc pt-2 text-white">Join 3000+ locals & 1400+ contributors from 2000 cities</p>
                            </div>
                            <div class="btn-box pt-4">
                                <a href="#" data-toggle="modal" data-target="#signupPopupForm" class="theme-btn border-0">Register Now</a>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="video-content z-index-1">
                        ...
                        <div class="video-content-box">
                            <div class="section-heading">
                                <h2 class="sec__title text-white line-height-55">Share the Beauty of Your <br> City to the World</h2>
                            </div><!-- end section-heading -->
                            <div class="btn-box pt-4">
    ...
    <section class="info-area section-bg padding-top-200px padding-bottom-100px text-center">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="btn-box">
                        <a href="#" data-toggle="modal" data-target="#signupPopupForm" class="theme-btn">Register Now</a>
                    </div>
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
        </div><!-- end container -->
