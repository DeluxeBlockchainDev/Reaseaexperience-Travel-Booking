        ...
        <div class="hero-box pb-0">
            <div id="fullscreen-slide-contain">
                <ul class="slides-container">
                    <li><img src="{{ asset('assets/images/hero-bg2.jpg') }}" alt=""></li>
                    <li><img src="{{ asset('assets/images/hero--bg2.jpg') }}" alt=""></li>
                    <li><img src="{{ asset('assets/images/hero--bg3.jpg') }}" alt=""></li>
                </ul>
                        ...
                        <div class="search-fields-container">
                            <div class="contact-form-action">
                                ...
                                <div class="btn-box pt-2">
                                    <a href="/room/search-result" class="theme-btn">Search Now</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- end col-lg-12 -->
                ...
                <div class="col-lg-6">
                    <div class="about-content pr-5">
                        ...
                        <div class="btn-box pt-4">
                            <a href="/about" class="theme-btn">Read More <i class="la la-arrow-right ml-1"></i></a>
                        </div>
                    </div>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
                    <div class="image-box about-img-box">
                        <img src="{{ asset('assets/images/img5.jpg') }}" alt="about-img" class="img__item img__item-1">
                        <img src="{{ asset('assets/images/tripadvisor.png') }}" alt="about-img" class="img__item img__item-2">
                    </div>
                </div><!-- end col-lg-6 -->
            </div><!-- end row -->
        </div><!-- end container -->
            ...
            <div class="row padding-top-50px">
                <div class="col-lg-6">
                    <div class="room-type-content">
                        <div class="image-box">
                            <a href="/room/search-list" class="d-block">
                                <img src="{{ asset('assets/images/img27.jpg') }}" alt="room type img" class="img__item">
                ...
                <div class="col-lg-6">
                    <div class="room-type-content">
                        <div class="image-box">
                            <a href="/room/search-list" class="d-block">
                                <img src="{{ asset('assets/images/img28.jpg') }}" alt="room type img" class="img__item">
                                <div class="room-type-link">
                ...
                <div class="col-lg-12">
                    <div class="discount-box">
                        <div class="discount-img">
                            <img src="{{ asset('assets/images/discount-hotel-img.jpg') }}" alt="discount img">
            ...
            <div class="row padding-top-50px">
                <div class="col-lg-4 responsive-column">
                    <div class="card-item blog-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/img5.jpg') }}" alt="blog-img">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title line-height-26"><a href="/blog/details">Best Scandinavian Accommodation – Treat Yourself</a></h3>
                                <p class="card-meta">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item blog-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/img6.jpg') }}" alt="blog-img">
                            <div class="post-format icon-element">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title line-height-26"><a href="/blog/details">Amazing Places to Stay in Norway</a></h3>
                                <p class="card-meta">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item blog-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/img7.jpg') }}" alt="blog-img">
                            <div class="post-format icon-element">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title line-height-26"><a href="/blog/details">Feel Like Home on Your Business Trip</a></h3>
                                <p class="card-meta">
