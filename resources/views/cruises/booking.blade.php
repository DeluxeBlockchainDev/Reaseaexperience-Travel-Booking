                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title text-white">Cruise Booking</h2>
                            </div>
                                    ...
                                    <div class="contact-form-action">
                                        <form method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="btn-box">
                                                        <button class="theme-btn" type="button">Login Account</button>
                                                    </div>
                                                </div><!-- end col-lg-12 -->
                                            </div>
                                        </form>
                            ...
                            <div class="card-item shadow-none radius-none mb-0">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="/cruise/details" class="btn ml-1"><i class="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                        </div>
                                    </div>
