                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-btn">
                            <div class="btn-box">
                                ...
                                data-speed="700"> -->
                                <a class="theme-btn" data-fancybox="video" data-src="{{ asset('assets/video/video-bg.mp4') }}"
                                data-speed="700">
                                    <i class="la la-video-camera mr-2"></i>Video
                                </a>
                                <a class="theme-btn" data-src="{{ asset('assets/images/img1.jpg') }}"
                            ...
                            <a class="d-none"
                                data-fancybox="gallery"
                                data-src="{{ asset('assets/images/img2.jpg') }}"
                                data-caption="Showing image - 02"
                                data-speed="700"></a>
                            <a class="d-none"
                                data-fancybox="gallery"
                                data-src="{{ asset('assets/images/img3.jpg') }}"
                                data-caption="Showing image - 03"
                                data-speed="700"></a>
                            <a class="d-none"
                                data-fancybox="gallery"
                                data-src="{{ asset('assets/images/img4.jpg') }}"
                                        ...
                                        <div class="cabin-type-item seat-selection-item d-flex">
                                            ...
                                            <div class="cabin-type-detail">
                                                ...
                                                <div class="room-photos">
                                                    <a class="btn theme-btn-hover-gray" data-src="{{ asset('assets/images/img1.jpg') }}"
                                                    data-fancybox="gallery"
                                                    data-caption="Showing image - 01"
                                                    data-speed="700">
