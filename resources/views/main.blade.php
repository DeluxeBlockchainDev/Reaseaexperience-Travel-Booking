                ...
                <div class="col-lg-10 mx-auto responsive--column-l">
                    <div class="hero-content pb-5">
                        <div class="section-heading">
                            <h2 class="sec__title cd-headline zoom">
                                ...
                                <b class="is-visible">Activities</b>
                                <b>Flights</b>
                                <b>Hotels</b>
                                <b>Transfers</b>
                                <b>Cruises</b>
                    ...
                    <div class="section-tab text-center pl-4">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center" id="transfer-tab" data-toggle="tab" href="#transfer" role="tab" aria-controls="transfer" aria-selected="true">
                                    <i class="la la-car mr-1"></i>Transfers
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center" id="tour-tab" data-toggle="tab" href="#tour" role="tab" aria-controls="tour" aria-selected="false">
                                    <i class="la la-globe mr-1"></i>Activities
                                </a>
                            </li>
                        </ul>
                    </div><!-- end section-tab -->
                    <div class="tab-content search-fields-container" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
                            ...
                            <div class="btn-box">
                                <a href="/hotel/search-result" class="theme-btn">Search Now</a>
                            </div>
                        </div><!-- end tab-pane -->
                        ...
                        <div class="tab-pane fade" id="tour" role="tabpanel" aria-labelledby="tour-tab">
                            ...
                            <div class="btn-box pt-3">
                                <a href="/activities/search-result" class="theme-btn">Search Now</a>
                            </div>
                        </div><!-- end tab-pane -->
                    </div>
                </div><!-- end col-lg-12 -->
                                    ...
                                    <div class="deal-card">
                                        <div class="deal-title d-flex align-items-center">
                                            ...
                                            <h3 class="deal__title">
                                                <a href="/flight/details" class="d-flex align-items-center">
                                        ...
                                        <div class="deal-action-box d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="/flight/details" class="btn-text">See details<i class="la la-angle-right"></i></a>
                                        </div>
                                    </div><!-- end deal-card -->
                                </div><!-- end col-lg-4 -->
                                <div class="col-lg-4 responsive-column">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4">
                <div class="btn-box btn--box text-right">
                    <a href="/activities/search-result" class="theme-btn">Discover More</a>
                </div>
            </div>
        </div><!-- end row -->
        <div class="row padding-top-50px">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="/activities/details">Oriental Pearl TV Tower</a></h3>
                        <div class="card-rating d-flex align-items-center">
                            <span class="ratings d-flex align-items-center mr-1">
                                <i class="la la-star"></i>
                                <i class="la la-star"></i>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="btn-box padding-top-35px">
                    <a href="/become-local-expert" class="theme-btn border-0">Join with us</a>
                </div>
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="col-lg-12">
                <div class="client-logo">
                    <div class="client-logo-item">
                        <img src="{{ asset('assets/images/client-logo.png') }}" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{ asset('assets/images/client-logo2.png') }}" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
                        <img src="{{ asset('assets/images/client-logo3.png') }}" alt="brand image">
                    </div><!-- end client-logo-item -->
                    <div class="client-logo-item">
