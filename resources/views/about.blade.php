            ...
            <div class="row">
                <div class="col-lg-4 responsive-column">
                    <div class="card-item" data-toggle="tooltip" data-placement="top" title="hello word">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/img21.jpg') }}" alt="about-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item ">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/img22.jpg') }}" alt="about-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item ">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/img23.jpg') }}" alt="about-img">
                        </div>
                        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto">
                    <div class="image-box about-img-box">
                        <img src="{{ asset('assets/images/img24.jpg') }}" alt="about-img" class="img__item img__item-1">
                        <img src="{{ asset('assets/images/img25.jpg') }}" alt="about-img" class="img__item img__item-2">
                    </div>
                </div><!-- end col-lg-5 -->
            </div><!-- end row -->
        </div><!-- end container -->
            ...
            <div class="row padding-top-100px">
                <div class="col-lg-4 responsive-column">
                    <div class="card-item team-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/team1.jpg') }}" alt="team-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item team-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/team2.jpg') }}" alt="team-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item team-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/team3.jpg') }}" alt="team-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item team-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/team4.jpg') }}" alt="team-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item team-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/team5.jpg') }}" alt="team-img">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item team-card">
                        <div class="card-img">
                            <img src="{{ asset('assets/images/team6.jpg') }}" alt="team-img">
                        </div>
                        <div class="card-body">
