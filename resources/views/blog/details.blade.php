                ...
                <div class="col-lg-8">
                    <div class="card-item blog-card blog-card-layout-2 blog-single-card mb-5">
                        <div class="card-img before-none">
                            <img src="{{ asset('assets/images/img20.jpg') }}" alt="blog-img">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 responsive-column">
                                        <div class="photo-block-item">
                                            <a href="{{ asset('assets/images/destination-img2.jpg') }}"
                                            data-fancybox="gallery"
                                            data-caption="Showing image - 01"
                                            data-speed="700">
                                                <img src="{{ asset('assets/images/destination-img2.jpg') }}" alt="img">
                                            </a>
                                        </div>
                                    </div><!-- end col-lg-4 -->
                                    <div class="col-lg-4 responsive-column">
                                        <div class="photo-block-item">
                                            <a href="{{ asset('assets/images/destination-img3.jpg') }}"
                                            data-fancybox="gallery"
                                            data-caption="Showing image - 02"
                                            data-speed="700">
                                                <img src="{{ asset('assets/images/destination-img3.jpg') }}" alt="img">
                                            </a>
                                        </div>
                                    </div><!-- end col-lg-4 -->
                                    <div class="col-lg-4 responsive-column">
                                        <div class="photo-block-item">
                                            <a href="{{ asset('assets/images/destination-img4.jpg') }}"
                                            data-fancybox="gallery"
                                            data-caption="Showing image - 03"
                                            data-speed="700">
                                                <img src="{{ asset('assets/images/destination-img4.jpg') }}" alt="img">
                                            </a>
                                        </div>
                                    </div><!-- end col-lg-4 -->
                                    <div class="col-lg-6 responsive-column">
                                        <div class="photo-block-item">
                                            <a href="{{ asset('assets/images/destination-img5.jpg') }}"
                                            data-fancybox="gallery"
                                            data-caption="Showing image - 04"
                                            data-speed="700">
                                                <img src="{{ asset('assets/images/destination-img5.jpg') }}" alt="img">
                                            </a>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                    <div class="col-lg-6 responsive-column">
                                        <div class="photo-block-item">
                                            <a href="{{ asset('assets/images/destination-img6.jpg') }}"
                                            data-fancybox="gallery"
                                            data-caption="Showing image - 05"
                                            data-speed="700">
                                                <img src="{{ asset('assets/images/destination-img6.jpg') }}" alt="img">
                                            </a>
                                        </div>
                                    </div><!-- end col-lg-6 -->
                                </div><!-- end row -->
                                ...
                                <div class="card-item blog-card">
                                    <div class="card-img">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title line-height-26"><a href="#">When Traveling Avoid Expensive Hotels & Resorts</a></h3>
                                            <p class="card-meta">
                                                <span class="post__date"> 1 January, 2020</span>
                                                <span class="post-dot"></span>
                                ...
                                <div class="card-item blog-card">
                                    <div class="card-img">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-title line-height-26"><a href="#">My Best Travel Tips: The Ultimate Travel Guide</a></h3>
                                            <p class="card-meta">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane " id="recent" role="tabpanel" aria-labelledby="recent-tab">
                                    <div class="card-item card-item-list recent-post-card">
                                        <div class="card-img">
                                            <a href="#" class="d-block">
                                                <img src="{{ asset('assets/images/small-img4.jpg') }}" alt="blog-img">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="card-title"><a href="#">Pack wisely before traveling</a></h3>
                                            <p class="card-meta">
                                    ...
                                    <div class="card-item card-item-list recent-post-card">
                                        <div class="card-img">
                                            <a href="#" class="d-block">
                                                <img src="{{ asset('assets/images/small-img5.jpg') }}" alt="blog-img">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="card-title"><a href="#">Change your place and get the fresh air</a></h3>
                                            <p class="card-meta">
                                                <span class="post__date"> 1 March, 2020</span>
                                                <span class="post-dot"></span>
                                                <span class="post__time">3 Mins read</span>
                                    ...
                                    <div class="card-item card-item-list recent-post-card mb-0">
                                        <div class="card-img">
                                            <a href="#" class="d-block">
                                                <img src="{{ asset('assets/images/small-img6.jpg') }}" alt="blog-img">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="card-title"><a href="#">Introducing this amazing city</a></h3>
                                            <p class="card-meta">
                                                <span class="post__date"> 1 March, 2020</span>
                                                <span class="post-dot"></span>
                                                <span class="post__time">3 Mins read</span>
                                ...
                                <div class="tab-pane fade show active" id="popular" role="tabpanel" aria-labelledby="popular-tab">
                                    <div class="card-item card-item-list recent-post-card">
                                        <div class="card-img">
                                            <a href="#" class="d-block">
                                                <img src="{{ asset('assets/images/small-img7.jpg') }}" alt="blog-img">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="card-title"><a href="#">The Castle on the Cliff: Majestic, Magic</a></h3>
                                            <p class="card-meta">
                                                <span class="post__date"> 1 March, 2020</span>
                                                <span class="post-dot"></span>
                                                <span class="post__time">3 Mins read</span>
                                    ...
                                    <div class="card-item card-item-list recent-post-card">
                                        <div class="card-img">
                                            <a href="#" class="d-block">
                                                <img src="{{ asset('assets/images/small-img8.jpg') }}" alt="blog-img">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="card-title"><a href="#">Change your place and get the fresh air</a></h3>
                                    ...
                                    <div class="card-item card-item-list recent-post-card mb-0">
                                        <div class="card-img">
                                            <a href="#" class="d-block">
                                                <img src="{{ asset('assets/images/small-img9.jpg') }}" alt="blog-img">
                                            </a>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="card-title"><a href="#">All Aboard the Rocky Mountaineer</a></h3>
                                            <p class="card-meta">
                                                <span class="post__date"> 1 March, 2020</span>
                                                <span class="post-dot"></span>
                                                <span class="post__time">3 Mins read</span>
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="sidebar-about">
                                <div class="sidebar-about-img">
                                    <img src="{{ asset('assets/images/destination-img3.jpg') }}" alt="">
