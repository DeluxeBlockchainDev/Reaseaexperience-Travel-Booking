                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title text-white">Transfer Booking</h2>
                            </div>
                            ...
                            <div class="card-item shadow-none radius-none mb-0">
                                <div class="card-img pb-4">
                                    <a href="/transfer/details" class="d-block">
                                        <img src="{{ asset('assets/images/car-img.jpg') }}" alt="car-img">
                                    </a>
                                </div>
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h3 class="card-title">Mercedes E Class or Similar</h3>
                                            <p class="card-meta">United States</p>
                                        </div>
                                        <div>
                                            <a href="/transfer/details" class="btn ml-1"><i class="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-items list-items-2 list-items-flush py-2">
                                        <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-calendar mr-1 font-size-17"></i>Date</span>12 May 2020 to 13 May 2020</li>
                                        <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-clock-o mr-1 font-size-17"></i>Time</span>12:10 pm to 3:50 pm</li>
                                        <li class="font-size-15"><span class="w-auto d-block mb-n1"><i class="la la-map-marker mr-1 font-size-17"></i>Location</span>New york city to New jersey airport</li>
                                    </ul>
                                    <h3 class="card-title pb-3">Order Details</h3>
                                    <div class="section-block"></div>
                                    <ul class="list-items list-items-2 py-3">
                                        <li><span>Mileage Included:</span>3,000 Miles</li>
                                        <li><span>Damage Protection:</span>$0.00 USD</li>
                                        <li><span>Per Day Price:</span>$24</li>
                                        <li><span>Passengers:</span>4</li>
                                    </ul>
                                    <div class="section-block"></div>
