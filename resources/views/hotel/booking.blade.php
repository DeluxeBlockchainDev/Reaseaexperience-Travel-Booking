                            ...
                            <div class="card-item shadow-none radius-none mb-0">
                                <div class="card-img pb-4">
                                    <a href="/hotel/details" class="d-block">
                                        <img src="{{ asset('assets/images/img1.jpg') }}" alt="tour-img">
                                    </a>
                                </div>
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="/hotel/details" class="btn ml-1"><i class="la la-edit" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section-block"></div>
                                    <h3 class="card-title pt-3 pb-2 font-size-15"><a href="/hotel/details">Order Details</a></h3>
                                    <div class="section-block"></div>
