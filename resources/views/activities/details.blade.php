                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-list breadcrumb-top-list">
                        <ul class="list-items bg-transparent radius-none p-0">
                            ...
                            <li>China</li>
                            <li>Great Wall of China, Activities</li>
                        </ul>
                                    ...
                                    <div class="accordion accordion-item padding-top-30px" id="accordionExample">
                                            ...
                                            <div id="faqCollapseOne" class="collapse show" aria-labelledby="faqHeadingOne" data-parent="#accordionExample">
                                                <div class="card-body d-flex align-items-center">
                                                    <div class="flex-shrink-0 mt-2 mr-4">
                                                        <img src="{{ asset('assets/images/small-img.jpg') }}" alt="destination-img">
                                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="faqCollapseTwo" class="collapse" aria-labelledby="faqHeadingTwo" data-parent="#accordionExample">
                                                <div class="card-body d-flex align-items-center">
                                                    <div class="flex-shrink-0 mt-2 mr-4">
                                                        <img src="{{ asset('assets/images/small-img2.jpg') }}" alt="destination-img">
                                                    </div>
                                                    <p>Mea appareat omittantur eloquentiam ad, nam ei quas oportere democritum. Prima causae admodum id est, ei timeam inimicus sed. Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="faqCollapseThree" class="collapse" aria-labelledby="faqHeadingThree" data-parent="#accordionExample">
                                                <div class="card-body d-flex align-items-center">
                                                    <div class="flex-shrink-0 mt-2 mr-4">
                                                        <img src="{{ asset('assets/images/small-img3.jpg') }}" alt="destination-img">
                                                    </div>
                                                    <p>Mea appareat omittantur eloquentiam ad, nam ei quas oportere democritum. Prima causae admodum id est, ei timeam inimicus sed. Sit an meis aliquam, cetero inermis vel ut. An sit illum euismod facilisis Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                                                </div>
                                            </div>
                        ...
                        <div class="sidebar single-content-sidebar mb-0">
                            <div class="sidebar-widget single-content-widget">
                                ...
                                <div class="btn-box pt-2">
                                    <a href="/activities/booking" class="theme-btn text-center w-100 mb-2"><i class="la la-shopping-cart mr-2 font-size-18"></i>Book Now</a>
            ...
            <div class="row padding-top-50px">
                    ...
                    <div class="card-item trending-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-price d-flex align-items-center justify-content-between">
                                ...
                                <a href="/activities/details" class="btn-text">View details<i class="la la-angle-right"></i></a>
                            </div>
                        </div>
                    </div><!-- end card-item -->
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 responsive-column">
                    <div class="card-item trending-card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="/activities/details">Hut on Blue Water Beach Tour</a></h3>
                ...
                <div class="col-lg-4 responsive-column">
                    <div class="card-item trending-card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="/activities/details">Golden Gate Seaplane Tour</a></h3>
                            <p class="card-meta">124 E Huron St, New york</p>
                            <div class="card-rating">
                                <span class="badge text-white">4.4/5</span>
