                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title text-white">Activities List</h2>
                            </div>
                    ...
                    <div class="filter-wrap margin-bottom-30px">
                        <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                            ...
                            <div class="layout-view d-flex align-items-center">
                                <a href="/activities/search-result" data-toggle="tooltip" data-placement="top" title="Grid View"><i class="la la-th-large"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-item card-item-list ">
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="/activities/details">Two Hours Guided Horseback Tour</a></h3>
                            <p class="card-meta">124 E Huron St, New york</p>
                            <div class="card-rating">
                                <span class="badge text-white">4.4/5</span>
                                <span class="review__text">Average</span>
                    ...
                    <div class="card-item card-item-list ">
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="/activities/details">Mangrove Tunnel Kayak Eco Tour</a></h3>
