                    ...
                    <div class="filter-wrap margin-bottom-40px">
                        <div class="filter-top d-flex align-items-center justify-content-between">
                            ...
                            <div class="layout-view d-flex align-items-center">
                                <a href="/room/search-grid" data-toggle="tooltip" data-placement="top" title="Grid View"><i class="la la-th-large"></i></a>
                        ...
                        <div class="col-lg-12">
                            <div class="card-item card-item-list room-card">
                                <div class="card-img-carousel carousel-action carousel--action">
                                    ...
                                    <div class="card-img">
                                        <a href="/room/details" class="d-block">
                                            <img src="{{ asset('assets/images/img29.jpg') }}" alt="hotel-img">
                                        </a>
                                    </div>
                                    <div class="card-img">
                                        <a href="/room/details" class="d-block">
                                            <img src="{{ asset('assets/images/img30.jpg') }}" alt="hotel-img">
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title font-size-26"><a href="/room/details">Premium Lake View Room</a></h3>
                                    ...
                                    <div class="card-btn">
                                        <a href="/room/details" class="theme-btn theme-btn-transparent">Book Now</a>
                                    </div>
                                </div>
                            </div><!-- end card-item -->
                        </div><!-- end col-lg-12 -->
                        <div class="col-lg-12">
                            <div class="card-item card-item-list room-card">
                                <div class="card-img-carousel carousel-action carousel--action">
                                    <div class="card-img">
                                        <a href="/room/details" class="d-block">
                                            <img src="{{ asset('assets/images/img31.jpg') }}" alt="hotel-img">
                                        </a>
                                    </div>
                                    <div class="card-img">
                                        <a href="/room/details" class="d-block">
                                            <img src="{{ asset('assets/images/img32.jpg') }}" alt="hotel-img">
                                        </a>
                                    </div>
                                    <div class="card-img">
                                        <a href="/room/details" class="d-block">
                                            <img src="{{ asset('assets/images/img33.jpg') }}" alt="hotel-img">
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title font-size-26"><a href="/room/details">Standard 2 Bed Male Dorm</a></h3>
                                    <p class="card-text pt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam asperiores commodi deleniti hic inventore laboriosam laborum molestias, non odit quaerat! Aperiam culpa facilis fuga impedit.</p>
                                    <div class="card-attributes pt-3 pb-4">
                                        <ul class="d-flex align-items-center">
                                            <li class="d-flex align-items-center"><i class="la la-bed"></i><span>2 Beds</span></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card-item card-item-list room-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title font-size-26"><a href="/room/details">Deluxe King Bed Private</a></h3>
                                    <p class="card-text pt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam asperiores commodi deleniti hic inventore laboriosam laborum molestias, non odit quaerat! Aperiam culpa facilis fuga impedit.</p>
                                    <div class="card-attributes pt-3 pb-4">
                                        <ul class="d-flex align-items-center">
                                            <li class="d-flex align-items-center"><i class="la la-bed"></i><span>2 Beds</span></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card-item card-item-list room-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title font-size-26"><a href="/room/details">Premium Lake View Suite</a></h3>
                                    <p class="card-text pt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam asperiores commodi deleniti hic inventore laboriosam laborum molestias, non odit quaerat! Aperiam culpa facilis fuga impedit.</p>
                                    <div class="card-attributes pt-3 pb-4">
                                        <ul class="d-flex align-items-center">
                                            <li class="d-flex align-items-center"><i class="la la-bed"></i><span>2 Beds</span></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card-item card-item-list room-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="card-title font-size-26"><a href="/room/details">Superior Room</a></h3>
                                    <p class="card-text pt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam asperiores commodi deleniti hic inventore laboriosam laborum molestias, non odit quaerat! Aperiam culpa facilis fuga impedit.</p>
                                    <div class="card-attributes pt-3 pb-4">
                                        <ul class="d-flex align-items-center">
                                            <li class="d-flex align-items-center"><i class="la la-bed"></i><span>2 Beds</span></li>
